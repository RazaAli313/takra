...
const HallOfFame = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white py-20 flex items-center justify-center">
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white py-20 flex items-center justify-center">
        <div className="text-center p-6 bg-red-900/20 border border-red-700 rounded-lg max-w-md">
          ...
          <button 
            ...
            className="px-4 py-2 bg-yellow-600 rounded-lg text-white font-medium hover:bg-yellow-700 transition"
          >
            Retry
          </button>
        </div>
      ...
      <div className="container mx-auto px-6">
        ...
        {achievements.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-400 text-xl">No achievements to display yet. Check back soon!</p>
          </div>
        ) : (
