...
const CogentLabsVerifyOtp = () => {
  ...
  const generateOTP = async () => {
    try {
      ...
      const response = await axios.post(`${API_BASE_URL}/cogentlabs/otp/generate`, {}, {
        headers: {
          'cogentLabsAuthToken': token
        },
        withCredentials: true
      });
      setSuccess("OTP has been generated!");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_BASE_URL}/cogentlabs/otp/verify`, {
        otp: otpValue
      }, {
        headers: {
          'cogentLabsAuthToken': token
      ...
      if (response.status === 200) {
        ...
        Cookies.set("cogentLabsOtpVerified", "true", { 
          path: "/", 
          expires: 1, // 1 day
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Enter the OTP to access Cogent Labs Admin</p>
        </div>
        ...
        <div className="mt-6 text-center text-gray-500 text-sm">
          ...
          {/* <p className="mt-2 text-cyan-400">OTP: 555555</p> */}
        </div>
      </motion.div>
    </div>
  );
...
export default CogentLabsVerifyOtp;
